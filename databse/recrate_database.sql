USE MyActivity
GO
DROP TABLE cultural_activity
DROP TABLE sport_activity
DROP TABLE leisure_activity
DROP TABLE subscription
DROP TABLE friends
DROP TABLE group_to_person 
DROP TABLE leisure_activity_type
DROP TABLE sport_activity_type
DROP TABLE cultural_activity_type
DROP TABLE groups
DROP TABLE person
DROP TABLE area_of_interes
